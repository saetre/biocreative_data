...
void FEATURE_EXTRACTOR::ext_WORD_feats(const COLUMN_INFO &COL_INFO, const V2_STR &one_sent, V2_STR &sent_feats)
{
...
void FEATURE_EXTRACTOR::ext_LEMMA_feats(const COLUMN_INFO &COL_INFO, const V2_STR &one_sent, V2_STR &sent_feats)
{
	string					one_feat= "", feat_head = "";
	string					feat_value1 = "", feat_value2 = "";
	string					feat_nor_value1 = "", feat_nor_value2 = "";
...
void FEATURE_EXTRACTOR::ext_ORTHO_feats(const COLUMN_INFO &COL_INFO, const V2_STR &one_sent, V2_STR &sent_feats)	
{
	bool					decision = true;
...
void FEATURE_EXTRACTOR::ext_POS_feats(const COLUMN_INFO &COL_INFO, const V2_STR &one_sent, V2_STR &sent_feats)
{
	string					one_feat= "", feat_head = "";
	string					feat_value1 = "", feat_value2 = "";
	V2_STR::iterator		i_row_feats = sent_feats.begin(), i_tmp_row;
...
void FEATURE_EXTRACTOR::ext_LEMMA_POS_feats(const COLUMN_INFO &COL_INFO, const V2_STR &one_sent, V2_STR &sent_feats)
{
	string					one_feat= "", feat_head = "";
...
void FEATURE_EXTRACTOR::ext_CHUNK_feats(const COLUMN_INFO &COL_INFO, const V2_STR &one_sent, V2_STR &sent_feats)
{
	...
	for (V2_STR::const_iterator i_row = one_sent.begin(); i_row != one_sent.end(); ++i_row) 
	{
		...
		*/
		...
		// Exact word features
		find_chunk_range(one_sent, i_row, COL_INFO, chk_range1);				// 1) Word "the" in the left context
...
void FEATURE_EXTRACTOR::ext_DIC_feats(const COLUMN_INFO &COL_INFO, const V2_STR &one_sent, V2_STR &sent_feats, int opt_dic)
{
...
void FEATURE_EXTRACTOR::get_n_grams(const string &token, const int n, vector<string> &ngrams)
{
	ngrams.clear();
...
string FEATURE_EXTRACTOR::get_item(
...
void FEATURE_EXTRACTOR::find_chunk_range(
	const V2_STR					&one_sent,
